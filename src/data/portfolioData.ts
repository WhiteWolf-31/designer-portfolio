export const personal = {
  name: "Sutharshana Suriyakumar",
  firstName: "SUTHARSHANA",
  lastName: "SURIYAKUMAR",
  role: "Creative Designer",
  location: "Vavuniya, Sri Lanka",
  address: "No. 225/46, Neriyakulam Road, Nelukkulam, Vavuniya, Sri Lanka",
...
export const skillCards = [
  {
    ...
    description: "Visual communication, marketing materials and digital graphics.",
  },
  {
    number: "02",
    title: "Branding",
    description: "Brand identity, visual language and brand consistency.",
  },
  {
    number: "03",
    title: "UI / UX",
    description: "User-centered interfaces and engaging digital experiences.",
  },
  {
    number: "04",
    title: "Multimedia",
    description: "Video, animation, presentations and visual storytelling.",
  },
];
...
export const education = [
  {
    ...
    field: "User Experience (UX) Design Web Design",
    description: "",
  },
  {
    period: "2025 – 2026",
